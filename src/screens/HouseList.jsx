...
const HouseList = ({ navigation }) => {
  const houses = [
    { id: 1, name: 'House 1', location: 'Location 1', price: '$600/month', image: 'https://pix10.agoda.net/hotelImages/281/2814216/2814216_17100223390057003416.jpg?s=1024x768' },
    ...
    { id: 10, name: 'House 10', location: 'Location 10', price: '$1400/month', image: 'https://3.bp.blogspot.com/-7FsLtuIi_yM/UKO8sMGpClI/AAAAAAAAUuU/_xZeePJq2Nc/s1600/unique-house-design.jpg' },
  ];
